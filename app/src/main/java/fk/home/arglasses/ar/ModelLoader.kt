...
/**
 *
 * FROM https://github.com/AyatKhraisat/ARCoreSample.git
 *
 ...
 */
class ModelLoader internal constructor(owner: FragmentActivity) {
    ...
    private val owner: WeakReference<FragmentActivity> = WeakReference(owner)
